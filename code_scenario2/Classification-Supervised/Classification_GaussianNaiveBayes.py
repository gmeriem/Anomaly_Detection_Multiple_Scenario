...
def plot(features, labels):
    notAttack = labels!=1
    attack = labels==1
    plt.scatter(features[notAttack, 1], features[notAttack, 0],c=labels[notAttack],cmap="Set3", label='normal')
    plt.scatter(features[attack, 1], features[attack, 0],c=labels[attack],cmap="Pastel1", label='attack')
